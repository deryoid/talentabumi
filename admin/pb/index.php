                        ...
                        <div class="col-12">
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#pb" class="btn bg-info"><i class="fa fa-print"> Cetak</i></a>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody style="background-color: white">
                                                <?php
                                                $no = 1;
                                                $data = $koneksi->query("SELECT * FROM pb ORDER BY id_pb ASC");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['satuan'] ?></td>
                                                        <td align="center">
                                                            <a href="edit?id=<?= $row['id_pb'] ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                                            <a href="hapus?id=<?= $row['id_pb'] ?>" class="btn btn-danger btn-sm alert-hapus" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
...
<!-- MODAL LAPORAN -->
<div id="pb" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> -->
                <h4 class="modal-title">PB</h4>
            </div>
            <div class="modal-body">

                <!-- kategori -->
                <label style="font-size: 15px; font-style: bold;">Tahun</label>
                <form method="POST" target="blank" action="<?= base_url('admin/pb/print.php') ?>">
                    <div class="row">
                        <div class="col-md-8">
