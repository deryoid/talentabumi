...
$id = $_GET['id'];
$data = $koneksi->query("SELECT * FROM pp WHERE id_pp = '$id'");
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('admin/pp/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
